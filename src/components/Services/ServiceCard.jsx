...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`glass-effect rounded-2xl p-8 flex flex-col justify-between h-full transform transition-all duration-500 cursor-pointer border border-white/10 ${
    ...
    >
      ...
      {/* Divider + Performance aligned */}
      <div className={`border-t border-${service.color}/40 pt-4 mt-auto`}>
